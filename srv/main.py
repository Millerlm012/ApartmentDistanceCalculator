...
def gather_inputs():
    ...
    destination_address = "4300 Westown Pkwy #150, West Des Moines, IA 50266"
...
def main(city, state, destination_address):
    ...
    while page_count <= total_pages:
        apartments, _ = parse_apartments(
            query_apartments(city, state, page_count), apartments
        )
        print(
    ...
    # apartments = [apt for apt in apartments if apt != []]
